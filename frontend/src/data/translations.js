...
const hi = {
  ...
  geolocationUnsupported: 'आपका ब्राउज़र स्थान सुविधा का समर्थन नहीं करता।',
  locationError: 'आपका स्थान नहीं मिल सका। कृपया लोकेशन की अनुमति दें।',
...
const gu = {
  ...
  loginError: 'લૉગ ઇન થઈ શક્યું નથી.',
  ...
  // Dashboard
  diseaseCardDesc: 'તાત્કાલિક નિદાન માટે પાકનો ફોટો અપલોડ કરો',
  historyCardDesc: 'તમારા અગાઉના નિદાન અને સારવાર જુઓ',
  noticesCardDesc: 'નવી યોજનાઓ, MSP, સબસિડી અને સમયમર્યાદા',
  expertsCardDesc: 'નજીકના કૃષિ કેન્દ્રો અને નિષ્ણાતો શોધો',
  chatbotCardDesc: 'પાક, જીવાત અને સિંચાઈ વિશે પ્રશ્ન પૂછો',
  ...
  noHistory: 'હજુ સુધી કોઈ ઇતિહાસ નથી — પહેલા રોગ ઓળખનો ઉપયોગ કરો.',

  // Government
  governmentNoticeBoard: 'સરકારી સૂચના બોર્ડ',
  loadingNotices: 'સૂચનાઓ લોડ થઈ રહી છે...',
  noNotices: 'કોઈ સૂચના ઉપલબ્ધ નથી.',
  noticesError: 'સરકારી સૂચનાઓ લોડ થઈ શકી નથી.',
  readMore: 'વધુ વાંચો',
  ...
  geolocationUnsupported: 'તમારું બ્રાઉઝર સ્થાન સુવિધાને સપોર્ટ કરતું નથી.',
  locationError: 'તમારું સ્થાન મળી શક્યું નથી. કૃપા કરીને સ્થાનની પરવાનગી આપો.',
  nearbyFetchError: 'નજીકના કૃષિ કેન્દ્રો મેળવી શકાયા નથી.',
  loadingCenters: 'નજીકના કેન્દ્રો શોધી રહ્યા છીએ...',
  noCenters: 'તમારા સ્થાનની નજીક કોઈ કૃષિ કેન્દ્ર મળ્યું નથી.',
...
// Dialects use Hindi-script UI as a practical fallback for uncommon
// technical terms, while AI responses use the actual dialect name.
const raj = {
  ...hi,
  appName: 'क्रॉपसेवर',
